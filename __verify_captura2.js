...
(async () => {
  ...
  await page.getByRole('button', { name: /Solar Center/ }).click({ timeout: 10000 });
  ...
  await page.screenshot({ path: `${OUT}/captura-manual-expanded.png` });
  console.log("saved captura-manual-expanded.png");
  await browser.close();
